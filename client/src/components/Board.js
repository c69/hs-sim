...
export default class Board extends Component {
  static propTypes = {
    ...
    passivePlayer: PropTypes.shape().isRequired,
        ...
        <EndTurn>
          {
            ...
            && <EndTurnButton
              ...
              onClick={() => this.props.endTurn({ optionIndex: endTurnActionIndex })}
            >End Turn</EndTurnButton>
          }
          <button onClick={() => this.props.endTurn({ optionIndex: 0 })}>
            Whatever First Action
          </button>
        </EndTurn>
